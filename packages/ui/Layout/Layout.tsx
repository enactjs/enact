...
interface LayoutBaseProps {
	 ...
	 * layout or horizontally in the case of a vertical layout, and optionally combines with a
	 * `justify-content` value separated by a space (e.g. `"center space-between"`).
	 */
	align?: string;
	...
	/**
	 * The type of component to use to render as the `Layout`. May be a DOM node name (e.g.
	 ...
	 *
	 * When using {@link ui/Layout.Layout}, the `ref` prop is forwarded to this component as
	 * `componentRef`.
	 */
	...
	/** Additional inline style applied to the rendered component. */
	style?: Record<string, any>;

	/**
	 * Sets the Layout's `flex-wrap` value.
	 *
	 * Works like a normal `Boolean` prop but also accepts `'wrap'`, `'nowrap'`, and `'reverse'`
	 * for finer-grained control.
	 */
	wrap?: boolean | 'reverse' | 'nowrap' | 'wrap';
