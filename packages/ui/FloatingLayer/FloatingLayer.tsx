 ...
 * @public
 */
class FloatingLayerBase extends Component<Record<string, any>, Record<string, any>> {
	...
	setFloatingLayer ({floatingLayer}: {floatingLayer: any}) {
	...
	render () {
		const {children, className, floatLayerClassName, open, scrimType, ...rest}: Record<string, any> = this.props;
...
const handleCancel = handle(
	...
	(ev: any, {open, noAutoDismiss, onDismiss}: Record<string, any>) => open && !noAutoDismiss && onDismiss,
