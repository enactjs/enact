 ...
 * @private
 */
function pushTranslucentScrim (scrim: Scrim) {
 ...
 * @private
 */
function removeTranslucentScrim (scrim: Scrim) {
 ...
 * @private
 */
class Scrim extends Component<Record<string, any>, Record<string, any>> {
	...
	static getDerivedStateFromProps (props: Record<string, any>) {
		if (props.type !== 'translucent') {
			return {
				visible: true
			};
	...
	render () {
		if (this.state.visible) {
			const {type, ...rest}: Record<string, any> = this.props;
