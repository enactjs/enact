 ...
 * @private
 */
export const validateRange = (value: number, min: number, max: number, component: string, valueName = 'value', minName = 'min', maxName = 'max'): boolean | undefined => {
	if (__DEV__) {
		let warned = false;
		if (value < min) {
...
export const validateRangeOnce = (thing: (...args: any[]) => any, {component, valueName = 'value', minName = 'min', maxName = 'max'}: {component: string; valueName?: string; minName?: string; maxName?: string}) => {
	if (__DEV__) {
		let displayed: boolean | undefined;
 ...
 * @private
 */
export const validateStepped = (value: number, min: number, step: number, component: string, valueName = 'value', stepName = 'step'): boolean => {
	if (__DEV__) {
...
export const validateSteppedOnce = (thing: (...args: any[]) => any, {component, minName = 'min', stepName = 'step', valueName = 'value'}: {component: string; minName?: string; stepName?: string; valueName?: string}) => {
	if (__DEV__) {
		let displayed: boolean | undefined;
