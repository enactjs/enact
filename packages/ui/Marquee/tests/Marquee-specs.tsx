...
import {Marquee, MarqueeBase, MarqueeController} from '../index';
...
describe('Marquee', () => {
	...
	test('should re-measure content after marqueeDisabled transitions to false', () => {
		...
		global.Element.prototype.getBoundingClientRect = jest.fn(function (this: any) {
	...
	test('should creates and observes with ResizeObserver', () => {
		...
		(global as any).ResizeObserver = jest.fn((cb: any) => {
			resizeCallback = cb;
			return {
				observe,
				disconnect: jest.fn()
