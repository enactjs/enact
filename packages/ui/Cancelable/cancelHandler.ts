 ...
 * @private
 */
const cancelHandlers: Array<(ev: any) => boolean> = [
	// always support the Escape key
	forKey('cancel') as (ev: any) => boolean
];
 ...
 * @private
 */
const forCancel = function (ev: any): boolean {
	let ok = false;
 ...
 * @public
 */
const addCancelHandler = function (handler: (ev: any) => boolean) {
 ...
 * @public
 */
const removeCancelHandler = function (handler: (ev: any) => boolean) {
