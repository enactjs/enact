...
function (_Component) {
  ...
  function ScrollableBaseNative(props) {
    ...
    _this.scrollByPage = function (direction) {
      var _this$uiRef$current2 = _this.uiRef.current,
          childRefCurrent = _this$uiRef$current2.childRefCurrent,
          scrollTop = _this$uiRef$current2.scrollTop,
        ...
        if (focusedItem) {
          ...
          if (contentNode.contains(focusedItem)) {
            var contentRect = contentNode.getBoundingClientRect(),
                ...
                y = bounds.maxTop - epsilon < scrollTop + pageDistance || epsilon > scrollTop + pageDistance ? contentNode.getBoundingClientRect()[isUp ? 'top' : 'bottom'] + yAdjust : (0, _util.clamp)(contentRect.top, contentRect.bottom, (clientRect.bottom + clientRect.top) / 2);
            focusedItem.blur();
    ...
    _this.onKeyDown = function (ev) {
      ...
      if (!repeat && _this.hasFocus()) {
        ...
        if (isPageUp(keyCode) || isPageDown(keyCode)) {
        ...
        } else if (!_spotlight["default"].getPointerMode() && (0, _spotlight.getDirection)(keyCode)) {
          ...
          if (overscrollEffectOn.arrowKey && !(element ? (0, _target.getTargetByDirectionFromElement)(direction, element) : null)) {
            var _this$uiRef$current3 = _this.uiRef.current,
                horizontalScrollbarRef = _this$uiRef$current3.horizontalScrollbarRef,
                verticalScrollbarRef = _this$uiRef$current3.verticalScrollbarRef;
    ...
    _this.onVoice = function (e) {
      var isHorizontal = _this.props.direction === 'horizontal',
          ...
          _this$uiRef$current4 = _this.uiRef.current,
          scrollTop = _this$uiRef$current4.scrollTop,
          scrollLeft = _this$uiRef$current4.scrollLeft,
    ...
    _this.handleScroll = (0, _handle["default"])((0, _handle.forward)('onScroll'), function (ev, _ref4, context) {
      var id = _ref4.id;
      return id && context && context.set;
    }, function (_ref5, _ref6, context) {
      var x = _ref5.scrollLeft,
          y = _ref5.scrollTop;
      var id = _ref6.id;
  ...
  _createClass(ScrollableBaseNative, [{
    ...
    value: function isScrollButtonFocused() {
      var _this$uiRef$current5 = this.uiRef.current,
          h = _this$uiRef$current5.horizontalScrollbarRef,
          v = _this$uiRef$current5.verticalScrollbarRef;
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_ScrollableNative.ScrollableBaseNative, Object.assign({
        ...
        start: this.start,
        containerRenderer: function containerRenderer(_ref7) {
          var childComponentProps = _ref7.childComponentProps,
              ChildWrapper = _ref7.childWrapper,
              _ref7$childWrapperPro = _ref7.childWrapperProps,
              contentClassName = _ref7$childWrapperPro.className,
              restChildWrapperProps = _objectWithoutProperties(_ref7$childWrapperPro, ["className"]),
              className = _ref7.className,
              componentCss = _ref7.componentCss,
              uiContainerRef = _ref7.containerRef,
              horizontalScrollbarProps = _ref7.horizontalScrollbarProps,
              initUiChildRef = _ref7.initChildRef,
              isHorizontalScrollbarVisible = _ref7.isHorizontalScrollbarVisible,
              isVerticalScrollbarVisible = _ref7.isVerticalScrollbarVisible,
              rtl = _ref7.rtl,
              scrollTo = _ref7.scrollTo,
              style = _ref7.style,
              verticalScrollbarProps = _ref7.verticalScrollbarProps;
...
ScrollableBaseNative.contextType = _SharedStateDecorator.SharedState;
