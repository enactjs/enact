...
- `moonstone/IncrementSlider` and `moonstone/Slider` props `tooltipAsPercent`, `tooltipSide`, and `tooltipForceSide`, to be replaced by `percent`, `side`, and `forceSide` on `moonstone/ProgressBar.ProgressBarTooltip`
