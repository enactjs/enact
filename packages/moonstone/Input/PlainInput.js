...
const PlainInputBase = kind({
	...
	computed: {
		...
		valueDirection: ({value}) => isRtlText(value) ? 'rtl' : 'ltr'
	},

	render: ({valueDirection, inputRef, ...rest}) => (
		<input {...rest} ref={inputRef} dir={valueDirection} />
	)
});

PlainInputBase.contextTypes = contextTypes;
