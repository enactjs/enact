...
import type {SpotlightContainerDecoratorConfig} from '../types/SpotlightContainerConfig';
import type {SpotlightContainerDecoratorProps} from '../types/SpotlightContainerProps';

import useSpotlightContainer from './useSpotlightContainer';

type ContainerHandlerName = 'onBlurCapture' | 'onFocusCapture' | 'onPointerEnter' | 'onPointerLeave';

const callContext = (name: ContainerHandlerName) => (ev: any, props: any, context: any) => context[name](ev, props);
 ...
 * @hocconfig
 */
const defaultConfig: SpotlightContainerDecoratorConfig = {
	/**
 ...
 * @hoc
 */
const SpotlightContainerDecorator = hoc(defaultConfig, (config: SpotlightContainerDecoratorConfig, Wrapped) => {
	const {navigableFilter, preserveId, ...containerConfig} = config;

	// eslint-disable-next-line no-shadow, @typescript-eslint/no-shadow
	function SpotlightContainerDecorator (props: SpotlightContainerDecoratorProps) {
	...
	return class SpotlightContainerDecoratorAdapter extends Component<SpotlightContainerDecoratorProps> {
		render () {
			return (
