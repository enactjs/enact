...
Spotlight is an extensible utility that enables users to navigate Enact
...
Spotlight enables navigation between Enact controls by assigning focus to one control 
...
levels of an Enact component tree.  Spotlight facilitates seamless navigation
