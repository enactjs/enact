...
import {spotLinear} from './tabTraversal';
...
const Spotlight = (function () {
	...
	*/
	...
	/*
	 * Tab/Shift+Tab handler. Builds a per-keypress target cache, delegates to tabTraversal,
	 * and calls preventDefault when focus moved or when paused (to keep Tab inside a modal).
	 */
