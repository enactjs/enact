...
const focusEffect: {className: string | null} = {
	className: null
};
 ...
 * @public
 */
const setFocusEffectClass = (className?: string | null): void => {
 ...
 * @private
 */
const getFocusEffectClass = (): string | null => focusEffect.className;
