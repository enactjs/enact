...
(function () {
  ...
  function navigate(dir) {
    ...
    let containerCSSSpatNavAction;
    if(!isContainer(eventTarget)) {
      containerCSSSpatNavAction = getCSSSpatNavAction(eventTarget.getSpatialNavigationContainer());
    } else {
      containerCSSSpatNavAction = getCSSSpatNavAction(eventTarget);
    }

    if (containerCSSSpatNavAction === 'scroll') {
      if (scrollingController(container, dir))
        return;
    } else if (containerCSSSpatNavAction === 'focus') {
