...
The HOC works by passing locale information to the app through [context](https://react.dev/learn/passing-data-deeply-with-context) and CSS classes. It passes three properties via context:
