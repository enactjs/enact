	...
	.add(
		...
		withInfo('A Tour of Sampler')(() => (
			<div>
				...
				<aside className={css.hintDialog} style={{top: riSafe(48), right: 9}}>
				...
				<aside className={css.hintDialog} style={{bottom: riSafe(198), left: 54}}>
					<Pointer length={186} style={riSafe({left: 9, bottom: -186})} />
					<div className={css.text}>
				...
				<aside className={css.hintDialog} style={{bottom: riSafe(42), left: 282}}>
