import {Header, HeaderBase, Panels, Panel} from '@enact/moonstone/Panels';
...
storiesOf('Moonstone', module)
	.add(
		...
		context => {
			...
			return (
				<Panels noCloseButton={boolean('noCloseButton', {displayName: 'Panels'}) || false} style={{position: 'fixed'}}>
					<Panel>
						<Header
